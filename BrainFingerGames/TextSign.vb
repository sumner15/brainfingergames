...
Public Class TextSign
    ...
    Public Sub drawSign()
        ...
        If visable Then
            ...
            GL.TexCoord2(0.0F, 1.0F) : GL.Vertex2(-w / 2, -h / 2)
            GL.TexCoord2(1.0F, 1.0F) : GL.Vertex2(w / 2, -h / 2)
            GL.TexCoord2(1.0F, 0.0F) : GL.Vertex2(w / 2, h / 2)
            GL.TexCoord2(0.0F, 0.0F) : GL.Vertex2(-w / 2, h / 2)
            GL.End()
