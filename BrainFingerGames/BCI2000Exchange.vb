...
#End Region
    ...
    Public Sub New(ByRef game As RehabHeroGame)
        ...
        'TODO: ship out as parameter values any further useful bits of session info from RehabHeroGame/FretBoard/FingerBot instances - e.g. GameType, GameMode, Gains, GameCodeVersion
    ...
    Public Sub New(ByRef game As RiffHeroGame)
        'timeBeginPeriod(timeRes)
        remote = New BCI2000Remote()
        remote.WindowVisible = operatorWindow
        If Not remote.Connect() Then Die()
        ...
        ' Parameter handling 0: Define any BCI2000 parameters that this experiment will use
        ExecuteScript("ADD PARAMETER Application:Versioning  string   HgIdTheBrainPart=         %     % % %")
        ExecuteScript("ADD PARAMETER Application:Versioning string    HgIdRiffHeroGame=        %     % % %")
        ExecuteScript("ADD PARAMETER Application:FingerBot  string    FingerBotHandedness=      %     % % %")
        ExecuteScript("ADD PARAMETER Application:FingerBot  floatlist AssistiveGains=       2   0 0   % 0 %")
        ExecuteScript("ADD PARAMETER Application:RiffHeroGame   string    SongPath=                 %     % % %")
        ExecuteScript("ADD PARAMETER Application:RiffHeroGame   int       NumberOfNotes=            0     0 0 %")
    ...
    Public Sub Update(ByRef game As RehabHeroGame)
    ...
    Public Sub Update(ByRef game As RiffHeroGame)
